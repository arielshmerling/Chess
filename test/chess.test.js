...
describe('Move Validation', () => {
    ...
    it("Check Validation not changing state", () => {
        let state = `{"board":[[{"color":"black","pieceType":4},{"color":"black","pieceType":2},{"color":"black","pieceType":3},{"color":"black","pieceType":5},{"color":"black","pieceType":1},{"color":"black","pieceType":3},{"color":"black","pieceType":2},{"color":"black","pieceType":4}],[{"color":"black","pieceType":0},{"color":"black","pieceType":0},{"color":"black","pieceType":0},{"color":"black","pieceType":0},null,null,{"color":"white","pieceType":0},{"color":"black","pieceType":0}],[null,null,null,null,null,null,null,null],[null,null,null,null,{"color":"black","pieceType":0},null,null,null],[null,null,null,null,null,null,null,null],[null,null,null,null,null,null,null,null],[{"color":"white","pieceType":0},{"color":"white","pieceType":0},{"color":"white","pieceType":0},{"color":"white","pieceType":0},null,{"color":"white","pieceType":0},{"color":"white","pieceType":0},{"color":"white","pieceType":0}],[{"color":"white","pieceType":4},{"color":"white","pieceType":2},{"color":"white","pieceType":3},{"color":"white","pieceType":5},{"color":"white","pieceType":1},{"color":"white","pieceType":3},{"color":"white","pieceType":2},{"color":"white","pieceType":4}]],"turn":"white","capturedPiecesList":[{"color":"black","pieceType":0},{"color":"black","pieceType":0}],"check":false,"checkmate":false,"draw":false,"drawReason":"","resigned":"","outOfTime":"","whiteKingMoved":false,"blackKingMoved":false,"whitePlayerView":true,"fiftyMovesCounter":0,"promoting":false,"queensideWhiteRookMoved":false,"queensideBlackRookMoved":false,"kingsideWhiteRookMoved":false,"kingsideBlackRookMoved":false,"lastMove":{"valid":true,"source":{"row":2,"col":4},"target":{"row":3,"col":4},"piece":{"color":"black","pieceType":0},"promotion":false,"ennPassant":false,"capturedPiece":null,"hitSquare":null,"turn":"black","castling":false,"whitePlayerView":true}}`;
        game.loadGame(state);
        source = { row: 1, col: 6 }
        target = { row: 0, col: 7 }
        assert.equal(JSON.stringify(game.GameState), state);
        assert.equal(game.validateMove(source, target, "white").valid, true);
        assert.equal(JSON.stringify(game.GameState), state);
...
describe('Verify Cant Make A Move After Draw', () => {
    it('Verify Cant Make A Move After Draw', () => {
        ...
        assert.equal(move.reason, game.Reasons.GAME_OVER, "The reason for invalid move should be Game Over");
...
describe('Castling tests', () => {
    ...
    it("White King can't castle if another piece exist between him and rook 2", () => {
        //Arrange

        let state = `{"board":[[{"color":"black","pieceType":4},{"color":"black","pieceType":2},{"color":"black","pieceType":3},{"color":"black","pieceType":5},{"color":"black","pieceType":1},{"color":"black","pieceType":3},{"color":"black","pieceType":2},{"color":"black","pieceType":4}],[{"color":"black","pieceType":0},{"color":"black","pieceType":0},null,{"color":"black","pieceType":0},{"color":"black","pieceType":0},{"color":"black","pieceType":0},{"color":"black","pieceType":0},{"color":"black","pieceType":0}],[null,null,null,null,null,null,null,null],[null,null,{"color":"black","pieceType":0},null,null,null,{"color":"white","pieceType":3},{"color":"white","pieceType":5}],[null,null,null,{"color":"white","pieceType":0},{"color":"white","pieceType":0},null,null,null],[null,null,null,null,null,null,null,null],[{"color":"white","pieceType":0},{"color":"white","pieceType":0},{"color":"white","pieceType":0},null,null,{"color":"white","pieceType":0},{"color":"white","pieceType":0},{"color":"white","pieceType":0}],[{"color":"white","pieceType":4},{"color":"white","pieceType":2},null,null,{"color":"white","pieceType":1},{"color":"white","pieceType":3},{"color":"white","pieceType":2},{"color":"white","pieceType":4}]],"turn":"white","capturedPiecesList":[],"algebricNotation":"1.e4 2.Kh6 3.Qh5 4.Kg8 5.d4 6.Kh6 7.Bg5 8.Kg8 9.Kc3 10.Kh6 11.Kd1 12.Kg8 ","check":false,"checkmate":false,"draw":false,"whiteKingMoved":false,"blackKingMoved":false,"queensideWhiteRookMoved":false,"queensideBlackRookMoved":false,"kingsideWhiteRookMoved":false,"kingsideBlackRookMoved":false,"whitePlayerView":true,"fiftyMovesCounter":0,"promoting":false,"lastMove":{"valid":true,"source":{"row":2,"col":2},"target":{"row":3,"col":2},"piece":{"color":"black","pieceType":0},"promotion":false,"ennPassant":false,"capturedPiece":null,"hitSquare":null,"turn":"black","castling":false,"whitePlayerView":true}}`;
        game.loadGame(state);
    ...
    it("Black King can't castle if another piece exist between him and rook 2", () => {
        //Arrange

        let state = `{"board":[[{"color":"black","pieceType":4},{"color":"black","pieceType":2},null,null,{"color":"black","pieceType":1},{"color":"black","pieceType":3},{"color":"black","pieceType":2},{"color":"black","pieceType":4}],[{"color":"black","pieceType":0},{"color":"black","pieceType":0},{"color":"black","pieceType":0},null,{"color":"black","pieceType":0},{"color":"black","pieceType":0},{"color":"black","pieceType":0},{"color":"black","pieceType":0}],[null,null,null,{"color":"black","pieceType":5},null,null,null,null],[null,null,null,{"color":"black","pieceType":0},null,{"color":"black","pieceType":3},null,null],[null,null,null,{"color":"white","pieceType":0},{"color":"white","pieceType":0},null,null,null],[null,null,{"color":"white","pieceType":0},null,null,null,null,null],[{"color":"white","pieceType":0},{"color":"white","pieceType":0},null,null,null,{"color":"white","pieceType":0},{"color":"white","pieceType":0},{"color":"white","pieceType":0}],[{"color":"white","pieceType":4},{"color":"white","pieceType":2},{"color":"white","pieceType":3},{"color":"white","pieceType":5},{"color":"white","pieceType":1},{"color":"white","pieceType":3},{"color":"white","pieceType":2},{"color":"white","pieceType":4}]],"turn":"black","capturedPiecesList":[],"check":false,"checkmate":false,"draw":false,"drawReason":"","resigned":"","outOfTime":"","whiteKingMoved":false,"blackKingMoved":false,"whitePlayerView":true,"fiftyMovesCounter":0,"promoting":false,"queensideWhiteRookMoved":false,"queensideBlackRookMoved":false,"kingsideWhiteRookMoved":false,"kingsideBlackRookMoved":false,"lastMove":{"valid":true,"source":{"row":6,"col":2},"target":{"row":5,"col":2},"piece":{"color":"white","pieceType":0},"promotion":false,"ennPassant":false,"capturedPiece":null,"hitSquare":null,"turn":"white","castling":false,"whitePlayerView":true}}`;
        game.loadGame(state);
    ...
    it("White King can't castle if another piece exist between him and rook 2 flipped board", () => {
        //Arrange

        let state = `{"board":[[{"color":"white","pieceType":4},{"color":"white","pieceType":2},{"color":"white","pieceType":3},{"color":"white","pieceType":1},null,null,{"color":"white","pieceType":2},{"color":"white","pieceType":4}],[{"color":"white","pieceType":0},{"color":"white","pieceType":0},{"color":"white","pieceType":0},null,null,{"color":"white","pieceType":0},{"color":"white","pieceType":0},{"color":"white","pieceType":0}],[{"color":"black","pieceType":0},null,null,null,{"color":"white","pieceType":5},null,null,null],[null,null,{"color":"white","pieceType":3},{"color":"white","pieceType":0},{"color":"white","pieceType":0},null,null,null],[null,null,null,null,null,null,null,null],[null,null,null,null,null,null,null,null],[null,{"color":"black","pieceType":0},{"color":"black","pieceType":0},{"color":"black","pieceType":0},{"color":"black","pieceType":0},{"color":"black","pieceType":0},{"color":"black","pieceType":0},{"color":"black","pieceType":0}],[{"color":"black","pieceType":4},{"color":"black","pieceType":2},{"color":"black","pieceType":3},{"color":"black","pieceType":1},{"color":"black","pieceType":5},{"color":"black","pieceType":3},{"color":"black","pieceType":2},{"color":"black","pieceType":4}]],"turn":"white","capturedPiecesList":[],"check":false,"checkmate":false,"draw":false,"drawReason":"","resigned":"","outOfTime":"","whiteKingMoved":false,"blackKingMoved":false,"whitePlayerView":false,"fiftyMovesCounter":0,"promoting":false,"queensideWhiteRookMoved":false,"queensideBlackRookMoved":false,"kingsideWhiteRookMoved":false,"kingsideBlackRookMoved":false,"lastMove":{"valid":true,"source":{"row":3,"col":0},"target":{"row":2,"col":0},"piece":{"color":"black","pieceType":0},"promotion":false,"ennPassant":false,"capturedPiece":null,"hitSquare":null,"turn":"black","castling":false,"whitePlayerView":false}}`;
        game.loadGame(state);
    ...
    it("Black King can't castle if another piece exist between him and rook 2 flipped board", () => {
        //Arrange

        let state = `{"board":[[{"color":"white","pieceType":4},{"color":"white","pieceType":2},{"color":"white","pieceType":3},{"color":"white","pieceType":1},{"color":"white","pieceType":5},{"color":"white","pieceType":3},{"color":"white","pieceType":2},{"color":"white","pieceType":4}],[null,{"color":"white","pieceType":0},{"color":"white","pieceType":0},null,{"color":"white","pieceType":0},{"color":"white","pieceType":0},{"color":"white","pieceType":0},{"color":"white","pieceType":0}],[null,null,null,null,null,null,null,null],[null,{"color":"black","pieceType":3},null,{"color":"white","pieceType":0},null,null,null,null],[{"color":"white","pieceType":0},null,null,null,{"color":"black","pieceType":0},null,null,null],[null,null,null,null,{"color":"black","pieceType":5},null,null,null],[{"color":"black","pieceType":0},{"color":"black","pieceType":0},{"color":"black","pieceType":0},{"color":"black","pieceType":0},null,{"color":"black","pieceType":0},{"color":"black","pieceType":0},{"color":"black","pieceType":0}],[{"color":"black","pieceType":4},{"color":"black","pieceType":2},{"color":"black","pieceType":3},{"color":"black","pieceType":1},null,null,{"color":"black","pieceType":2},{"color":"black","pieceType":4}]],"turn":"black","capturedPiecesList":[],"check":false,"checkmate":false,"draw":false,"drawReason":"","resigned":"","outOfTime":"","whiteKingMoved":false,"blackKingMoved":false,"whitePlayerView":false,"fiftyMovesCounter":0,"promoting":false,"queensideWhiteRookMoved":false,"queensideBlackRookMoved":false,"kingsideWhiteRookMoved":false,"kingsideBlackRookMoved":false,"lastMove":{"valid":true,"source":{"row":3,"col":0},"target":{"row":4,"col":0},"piece":{"color":"white","pieceType":0},"promotion":false,"ennPassant":false,"capturedPiece":null,"hitSquare":null,"turn":"white","castling":false,"whitePlayerView":false}}`;
        game.loadGame(state);
...
describe("Draw tests", () => {
    it("Stalemate cases a draw", () => {
        ...
        assert.equal(verifyCall, true);
        assert.equal(game.DrawReason, "Stalemate");
    ...
    it("Threefold Repetition cases a draw", () => {
        ...
        assert.equal(game.DrawReason, game.GameOverReason);
...
describe("ChessGame Properties test", () => {
    it("GameTimeLength", () => {
        game.startNewGame()
        game.loadGame(initalState);
        game.GameTimeLength = 60 * 60 * 0.5;
        assert.equal(game.GameTimeLength, 60 * 60 * 0.5);
    });
    ...
    it("OutOfTime white", () => {
        ...
        assert.equal(game.OutOfTime, "white");
        assert.equal(game.ResultMove.moveStr, "0-1");
    ...
    it("OutOfTime black", () => {
        ...
        assert.equal(game.OutOfTime, "black");
        assert.equal(game.ResultMove.moveStr, "1-0");

    });

    it("Result move is null if game is not over", () => {
        game.startNewGame()
        game.loadGame(initalState);
    ...
    it("Last move property returns the last move", () => {
        game.startNewGame()
        game.loadGame(initalState);
        assert.equal(game.GameOver, false);
        assert.equal(game.ResultMove, null);
...
describe("Special cases", () => {
    ...
    it("White Player resigned on intial state", () => {
        game.startNewGame()
        game.loadGame(initalState);
        game.resign("white");
        assert.equal(game.GameOverReason, "white Player Resigned.");
    })

    it("Black Player resigned on intial state", () => {
        game.startNewGame()
        game.loadGame(initalState);
        game.resign("black");
    ...
    it("Black Player resigned on non intial state", () => {
        const state = `{"board":[[null,null,null,null,null,null,null,null],[null,null,null,null,null,null,null,null],[{"color":"white","pieceType":5},{"color":"black","pieceType":2},null,null,null,null,null,null],[null,null,{"color":"black","pieceType":0},null,{"color":"white","pieceType":0},null,{"color":"black","pieceType":0},null],[null,{"color":"black","pieceType":1},null,{"color":"white","pieceType":0},{"color":"white","pieceType":2},null,null,null],[null,null,{"color":"white","pieceType":3},null,null,null,null,null],[{"color":"white","pieceType":0},null,null,null,{"color":"white","pieceType":3},{"color":"white","pieceType":0},{"color":"white","pieceType":0},{"color":"white","pieceType":0}],[null,{"color":"white","pieceType":4},null,null,{"color":"white","pieceType":1},null,null,{"color":"white","pieceType":4}]],"turn": "black","capturedPiecesList":[{"color":"black","pieceType":4},{"color":"black","pieceType":3},{"color":"white","pieceType":2},{"color":"black","pieceType":3},{"color":"black","pieceType":0},{"color":"black","pieceType":0},{"color":"black","pieceType":2},{"color":"white","pieceType":0},{"color":"black","pieceType":0},{"color":"black","pieceType":0},{"color":"black","pieceType":0},{"color":"white","pieceType":0},{"color":"black","pieceType":5},{"color":"black","pieceType":0},{"color":"black","pieceType":4}],"algebricNotation":"1.e4 2.Bc3+ ","check":true,"checkmate":false,"draw":false,"whiteKingMoved":false,"blackKingMoved":true,"whitePlayerView":true,"fiftyMovesCounter":1,"promoting":false,"queensideWhiteRookMoved":true,"queensideBlackRookMoved":true,"kingsideWhiteRookMoved":false,"kingsideBlackRookMoved":false,"lastMove":{"valid":true,"source":{"row":6,"col":1},"target":{"row":5,"col":2},"piece":{"color":"white","pieceType":3},"promotion":false,"ennPassant":false,"capturedPiece":null,"hitSquare":null,"turn":"white","castling":false,"whitePlayerView":true,"check":true}}`;
        game.startNewGame()
        game.loadGame(state);
        game.resign("black");
    ...
    it("White Player resigned on non intial state", () => {
        const state = `{"board":[[null,null,null,null,null,null,null,null],[null,null,null,null,null,null,null,null],[{"color":"white","pieceType":5},{"color":"black","pieceType":2},null,null,null,null,null,null],[null,null,{"color":"black","pieceType":0},null,{"color":"white","pieceType":0},null,{"color":"black","pieceType":0},null],[null,{"color":"black","pieceType":1},null,{"color":"white","pieceType":0},{"color":"white","pieceType":2},null,null,null],[null,null,{"color":"white","pieceType":3},null,null,null,null,null],[{"color":"white","pieceType":0},null,null,null,{"color":"white","pieceType":3},{"color":"white","pieceType":0},{"color":"white","pieceType":0},{"color":"white","pieceType":0}],[null,{"color":"white","pieceType":4},null,null,{"color":"white","pieceType":1},null,null,{"color":"white","pieceType":4}]],"turn": "black","capturedPiecesList":[{"color":"black","pieceType":4},{"color":"black","pieceType":3},{"color":"white","pieceType":2},{"color":"black","pieceType":3},{"color":"black","pieceType":0},{"color":"black","pieceType":0},{"color":"black","pieceType":2},{"color":"white","pieceType":0},{"color":"black","pieceType":0},{"color":"black","pieceType":0},{"color":"black","pieceType":0},{"color":"white","pieceType":0},{"color":"black","pieceType":5},{"color":"black","pieceType":0},{"color":"black","pieceType":4}],"algebricNotation":"1.e4 2.Bc3+ ","check":true,"checkmate":false,"draw":false,"whiteKingMoved":false,"blackKingMoved":true,"whitePlayerView":true,"fiftyMovesCounter":1,"promoting":false,"queensideWhiteRookMoved":true,"queensideBlackRookMoved":true,"kingsideWhiteRookMoved":false,"kingsideBlackRookMoved":false,"lastMove":{"valid":true,"source":{"row":6,"col":1},"target":{"row":5,"col":2},"piece":{"color":"white","pieceType":3},"promotion":false,"ennPassant":false,"capturedPiece":null,"hitSquare":null,"turn":"white","castling":false,"whitePlayerView":true,"check":true}}`;
        game.startNewGame()
        game.loadGame(state);
        game.resign("white");
    ...
    it("White Player accepted a draw offer", () => {
        const state = `{"board":[[null,null,null,null,null,null,null,null],[null,null,null,null,null,null,null,null],[{"color":"white","pieceType":5},{"color":"black","pieceType":2},null,null,null,null,null,null],[null,null,{"color":"black","pieceType":0},null,{"color":"white","pieceType":0},null,{"color":"black","pieceType":0},null],[null,{"color":"black","pieceType":1},null,{"color":"white","pieceType":0},{"color":"white","pieceType":2},null,null,null],[null,null,{"color":"white","pieceType":3},null,null,null,null,null],[{"color":"white","pieceType":0},null,null,null,{"color":"white","pieceType":3},{"color":"white","pieceType":0},{"color":"white","pieceType":0},{"color":"white","pieceType":0}],[null,{"color":"white","pieceType":4},null,null,{"color":"white","pieceType":1},null,null,{"color":"white","pieceType":4}]],"turn": "black","capturedPiecesList":[{"color":"black","pieceType":4},{"color":"black","pieceType":3},{"color":"white","pieceType":2},{"color":"black","pieceType":3},{"color":"black","pieceType":0},{"color":"black","pieceType":0},{"color":"black","pieceType":2},{"color":"white","pieceType":0},{"color":"black","pieceType":0},{"color":"black","pieceType":0},{"color":"black","pieceType":0},{"color":"white","pieceType":0},{"color":"black","pieceType":5},{"color":"black","pieceType":0},{"color":"black","pieceType":4}],"algebricNotation":"1.e4 2.Bc3+ ","check":true,"checkmate":false,"draw":false,"whiteKingMoved":false,"blackKingMoved":true,"whitePlayerView":true,"fiftyMovesCounter":1,"promoting":false,"queensideWhiteRookMoved":true,"queensideBlackRookMoved":true,"kingsideWhiteRookMoved":false,"kingsideBlackRookMoved":false,"lastMove":{"valid":true,"source":{"row":6,"col":1},"target":{"row":5,"col":2},"piece":{"color":"white","pieceType":3},"promotion":false,"ennPassant":false,"capturedPiece":null,"hitSquare":null,"turn":"white","castling":false,"whitePlayerView":true,"check":true}}`;
        game.startNewGame()
        game.loadGame(state);
    ...
    it("White Player accepted a draw offer", () => {
        ...
        assert.equal(game.ResultMove.moveStr, "1/2-1/2");
        assert.equal(game.DrawReason, "black player's draw offer accepted");
    })
...
describe("PGN Move Tests", () => {
    ...
    it("e4", () => {
        ...
        assert.deepEqual(move.target, { row: 4, col: 4 });
        assert.equal(move.moveStr, "e4");
        assert.equal(move.piece, game.PAWN);
    });
    it("O-O white", () => {
        const move = game.parsePGNMove("O-O", "white");
        assert.equal(move.castling, true);
        assert.equal(move.kingSide, true);
        assert.equal(move.moveStr, "O-O");
        assert.equal(move.piece, game.KING);
        assert.deepEqual(move.target, { row: 7, col: 6 });
    });

    it("O-O-O white", () => {
        const move = game.parsePGNMove("O-O-O", "white");
        assert.equal(move.castling, true);
        assert.equal(move.queenSide, true);
        assert.equal(move.moveStr, "O-O-O");
        assert.equal(move.piece, game.KING);
        assert.deepEqual(move.target, { row: 7, col: 2 });
    });

    it("O-O black", () => {
        const move = game.parsePGNMove("O-O", "black");
        assert.equal(move.castling, true);
        assert.equal(move.kingSide, true);
        assert.equal(move.moveStr, "O-O");
        assert.equal(move.piece, game.KING);
    ...
    it("O-O-O black", () => {
        const move = game.parsePGNMove("O-O-O", "black");
        assert.equal(move.castling, true);
        assert.equal(move.queenSide, true);
        assert.equal(move.moveStr, "O-O-O");
        assert.equal(move.piece, game.KING);
        assert.deepEqual(move.target, { row: 0, col: 2 });
    });

    it("Pawn Move", () => {
        game.loadGame(initalState);
        const move = game.convertPGNMove({ moveStr: "e4", color: "white" });
    ...
    it("Pawn Capture", () => {
        game.loadGame(initalState);
        const move = game.convertPGNMove({ moveStr: "exd4", color: "white" });
        assert.deepEqual(move.source, { row: 5, col: 4 });
        assert.deepEqual(move.target, { row: 4, col: 3 });
        assert.equal(move.valid, true);
        assert.equal(move.capture, true);
        assert.equal(move.moveStr, "exd4");
        assert.equal(move.piece, game.PAWN);
    });

    it("Pawn Promotion", () => {
        game.loadGame(initalState);
        const move = game.convertPGNMove({ moveStr: "gxh8=Q", color: "white" });
        assert.deepEqual(move.source, { row: 1, col: 6 });
        assert.deepEqual(move.target, { row: 0, col: 7 });
        assert.equal(move.valid, true);
        assert.equal(move.capture, true);
        assert.equal(move.promotedTo, 'Q');
        assert.equal(move.moveStr, "gxh8=Q");
        assert.equal(move.piece, game.PAWN);
    });

    it("Check", () => {
        game.loadGame(initalState);
        const move = game.convertPGNMove({ moveStr: "Qe4+", color: "white" });
        assert.deepEqual(move.target, { row: 4, col: 4 });
        assert.equal(move.valid, true);
        assert.equal(move.check, true);
        assert.equal(move.moveStr, "Qe4+");
        assert.equal(move.piece, game.QUEEN);
    });
    ...
    it("Knight Move", () => {
        game.loadGame(initalState);
        const move = game.convertPGNMove({ moveStr: "Nc3", color: "white" });
        assert.deepEqual(move.source, { row: 7, col: 1 });
        assert.deepEqual(move.target, { row: 5, col: 2 });
        assert.equal(move.valid, true);
        assert.equal(move.moveStr, "Nc3");
...
describe("ChessGame coverage gaps", () => {
    function loadEmpty(pieces, overrides = {}) {
        const board = Array.from({ length: 8 }, () => Array(8).fill(null));
        for (const { row, col, color, pieceType } of pieces) {
            board[row][col] = { color, pieceType };
        }
    ...
    describe("state helpers and notation edge cases", () => {
        it("SavedGameState strips volatile fields from the snapshot", () => {
            game.startNewGame(true);
            game.makeMove({ row: 6, col: 4 }, { row: 4, col: 4 });
            const saved = game.SavedGameState;
            assert.equal(saved.includes("capturedPiecesList"), false);
            assert.equal(saved.includes("fiftyMovesCounter"), false);
            assert.equal(saved.includes("lastMove"), false);
        });

        it("SearchMode skips getPGNMoveNotation output", () => {
            game.startNewGame(true);
            game.SearchMode = true;
            assert.equal(
                game.getPGNMoveNotation({
                    valid: true,
                    source: { row: 6, col: 4 },
                    target: { row: 4, col: 4 },
                    piece: { color: "white", pieceType: game.PAWN },
        ...
        it("loadMoves notifies listeners and loadGame clears a stale promoting flag", () => {
            let updateCount = 0;
            game.OnUpdate = () => { updateCount++; };
            game.loadGame(loadEmpty([], { promoting: true }));
            assert.equal(game.GameState.promoting, false);
            assert.ok(updateCount >= 1);
            game.loadMoves([{ moveStr: "e4" }]);
            assert.ok(updateCount >= 2);
        });

        it("completePromotion still works when the moves list was cleared", () => {
            game.loadGame(loadEmpty([
                { row: 1, col: 6, color: "white", pieceType: game.PAWN },
                { row: 0, col: 7, color: "black", pieceType: game.PAWN },
                ...standardKings(),
            ]));
            const promoMove = game.makeMove({ row: 1, col: 6 }, { row: 0, col: 7 });
            game.loadMoves([]);
            promoMove.selectedPiece = game.QUEEN;
            game.completePromotion(promoMove);
            assert.equal(game.GameState.promoting, false);
            assert.equal(game.Moves.length, 1);
            assert.equal(game.GameState.board[0][7].pieceType, game.QUEEN);
        });

        it("evaluate() initializes a missing capturedPiecesList", () => {
            const state = JSON.parse(loadEmpty([
                { row: 6, col: 4, color: "white", pieceType: game.PAWN },
                ...standardKings(),
            ]));
            delete state.capturedPiecesList;
            game.loadGame(JSON.stringify(state));
            const result = game.evaluate();
            assert.equal(Array.isArray(game.GameState.capturedPiecesList), true);
            assert.equal(result.draw, false);
        });

        it("colorName, pieceName, and letterToPiece cover naming helpers", () => {
            assert.equal(game.colorName("white"), "White");
            assert.equal(game.colorName("black"), "Black");
            assert.equal(game.colorName("purple"), "ERROR");
            assert.equal(game.pieceName(game.PAWN), "Pawn");
            assert.equal(game.pieceName(game.ROOK), "Rook");
            assert.equal(game.pieceName(game.KNIGHT), "Knight");
            assert.equal(game.pieceName(game.BISHOP), "Bishop");
            assert.equal(game.pieceName(game.KING), "King");
            assert.equal(game.pieceName(game.QUEEN), "Queen");
            assert.equal(game.pieceName(999), "Error");
            assert.equal(game.letterToPiece("X"), game.PAWN);
        });

        it("getPGNMoveNotation disambiguates rooks on the same rank or file", () => {
            game.loadGame(loadEmpty([
                { row: 4, col: 0, color: "white", pieceType: game.ROOK },
                { row: 4, col: 7, color: "white", pieceType: game.ROOK },
                ...standardKings(),
            ]));
            const rankMove = game.makeMove({ row: 4, col: 0 }, { row: 4, col: 3 });
            assert.equal(game.getPGNMoveNotation(rankMove), "Rad4");
            ...
            const fileMove = game.makeMove({ row: 3, col: 0 }, { row: 3, col: 3 });
            assert.equal(game.getPGNMoveNotation(fileMove), "Rd5");
        });

        it("uses rank disambiguation when two rooks on the same file can reach the target", () => {
            game.loadGame(loadEmpty([
                { row: 7, col: 2, color: "white", pieceType: game.ROOK },
                { row: 0, col: 2, color: "white", pieceType: game.ROOK },
                ...standardKings(),
            ]));
            const move = game.makeMove({ row: 0, col: 2 }, { row: 4, col: 2 });
            assert.equal(game.getPGNMoveNotation(move), "R8c4");
            ...
            const flippedMove = game.makeMove({ row: 0, col: 2 }, { row: 4, col: 2 });
            assert.equal(game.getPGNMoveNotation(flippedMove), "R1f5");
        });

        it("sorts capturedPiecesList after an en passant capture", () => {
            game.loadGame(loadEmpty([
                { row: 0, col: 0, color: "black", pieceType: game.KING },
                { row: 3, col: 0, color: "black", pieceType: game.PAWN },
                { row: 3, col: 1, color: "white", pieceType: game.PAWN },
                { row: 7, col: 4, color: "white", pieceType: game.KING },
            ], {
                turn: "white",
                lastMove: {
                    ...
                    source: { row: 1, col: 0 },
                    target: { row: 3, col: 0 },
                    piece: { color: "black", pieceType: game.PAWN },
                    promotion: false,
                    ennPassant: false,
                    capturedPiece: null,
                    hitSquare: null,
            ...
            assert.equal(ep.ennPassant, true);
            assert.ok(
                game.GameState.capturedPiecesList.some(
                    (p) => p.pieceType === game.PAWN && p.color === "black"
                )
            );
        });

        it("reports K+N vs K+B as insufficient material in either orientation", () => {
            game.loadGame(loadEmpty([
                { row: 7, col: 4, color: "white", pieceType: game.KING },
                { row: 5, col: 2, color: "white", pieceType: game.BISHOP },
                { row: 0, col: 4, color: "black", pieceType: game.KING },
                { row: 2, col: 5, color: "black", pieceType: game.KNIGHT },
            ]));
            ...
            game.loadGame(loadEmpty([
                { row: 7, col: 4, color: "white", pieceType: game.KING },
                { row: 5, col: 2, color: "white", pieceType: game.KNIGHT },
                { row: 0, col: 4, color: "black", pieceType: game.KING },
                { row: 2, col: 5, color: "black", pieceType: game.BISHOP },
            ]));
        ...
        it("rejects moves for pieces with an unknown pieceType", () => {
            game.loadGame(loadEmpty([
                { row: 4, col: 4, color: "white", pieceType: 99 },
                ...standardKings(),
            ]));
            const move = game.validateMove({ row: 4, col: 4 }, { row: 3, col: 4 }, "white");
            assert.equal(move.valid, false);
        });
    });

    describe("findSource coverage for sliding pieces and king moves", () => {
        it("finds bishops approaching the target from each diagonal", () => {
            const cases = [
                [{ row: 0, col: 0, color: "white", pieceType: game.BISHOP }, "Be4", { row: 0, col: 0 }],
                [{ row: 7, col: 7, color: "white", pieceType: game.BISHOP }, "Be4", { row: 7, col: 7 }],
                [{ row: 1, col: 7, color: "white", pieceType: game.BISHOP }, "Be4", { row: 1, col: 7 }],
                [{ row: 7, col: 1, color: "white", pieceType: game.BISHOP }, "Be4", { row: 7, col: 1 }],
            ];
            for (const [bishop, pgn, expectedSource] of cases) {
                game.loadGame(loadEmpty([bishop, ...standardKings()]));
                assert.deepEqual(convert(pgn).source, expectedSource, pgn);
            }
        });

        it("finds queens on each diagonal, rank, and file toward the target", () => {
            const cases = [
                [{ row: 7, col: 7, color: "white", pieceType: game.QUEEN }, "Qe4", { row: 7, col: 7 }],
                [{ row: 0, col: 0, color: "white", pieceType: game.QUEEN }, "Qe4", { row: 0, col: 0 }],
                [{ row: 1, col: 7, color: "white", pieceType: game.QUEEN }, "Qe4", { row: 1, col: 7 }],
                [{ row: 7, col: 1, color: "white", pieceType: game.QUEEN }, "Qe4", { row: 7, col: 1 }],
                [{ row: 2, col: 4, color: "white", pieceType: game.QUEEN }, "Qe4", { row: 2, col: 4 }],
                [{ row: 4, col: 0, color: "white", pieceType: game.QUEEN }, "Qe4", { row: 4, col: 0 }],
                [{ row: 4, col: 7, color: "white", pieceType: game.QUEEN }, "Qe4", { row: 4, col: 7 }],
            ];
            for (const [queen, pgn, expectedSource] of cases) {
                game.loadGame(loadEmpty([
                    queen,
                    { row: 7, col: 4, color: "white", pieceType: game.KING },
                    { row: 0, col: 7, color: "black", pieceType: game.KING },
        ...
        it("disambiguates queens that share a rank, file, or diagonal", () => {
            game.loadGame(loadEmpty([
                { row: 4, col: 0, color: "white", pieceType: game.QUEEN },
                { row: 4, col: 7, color: "white", pieceType: game.QUEEN },
                ...standardKings(),
            ...
            game.loadGame(loadEmpty([
                { row: 0, col: 0, color: "white", pieceType: game.QUEEN },
                { row: 7, col: 7, color: "white", pieceType: game.QUEEN },
                ...standardKings(),
            ]));
            assert.deepEqual(convert("Qae4").source, { row: 0, col: 0 });
            assert.deepEqual(convert("Qhe4").source, { row: 7, col: 7 });
        });

        it("finds rooks from vertical and horizontal directions and disambiguates them", () => {
            game.loadGame(loadEmpty([
                { row: 7, col: 3, color: "white", pieceType: game.ROOK },
                ...standardKings(),
            ]));
            assert.deepEqual(convert("Rd4").source, { row: 7, col: 3 });

            game.loadGame(loadEmpty([
                { row: 4, col: 0, color: "white", pieceType: game.ROOK },
                ...standardKings(),
            ]));
            assert.deepEqual(convert("Re4").source, { row: 4, col: 0 });

            game.loadGame(loadEmpty([
                { row: 4, col: 0, color: "white", pieceType: game.ROOK },
                { row: 0, col: 3, color: "white", pieceType: game.ROOK },
                { row: 7, col: 4, color: "white", pieceType: game.KING },
                { row: 0, col: 7, color: "black", pieceType: game.KING },
            ]));
            assert.deepEqual(convert("Rad4").source, { row: 4, col: 0 });
        ...
        it("finds knights around the target from each legal offset", () => {
            const knightSources = [
                { row: 6, col: 5 }, { row: 6, col: 3 }, { row: 5, col: 6 }, { row: 5, col: 2 },
                { row: 3, col: 6 }, { row: 3, col: 2 }, { row: 2, col: 5 }, { row: 2, col: 3 },
            ];
            for (const source of knightSources) {
                game.loadGame(loadEmpty([
                    { ...source, color: "white", pieceType: game.KNIGHT },
                    ...standardKings(),
                ]));
                assert.deepEqual(convert("Ne4").source, source);
            }
        });

        it("finds the king source from every adjacent direction", () => {
            game.loadGame(loadEmpty([
                { row: 6, col: 4, color: "white", pieceType: game.KING },
                { row: 0, col: 7, color: "black", pieceType: game.KING },
            ]));
            const cases = [
                ["Kd1", { row: 7, col: 3 }], ["Ke1", { row: 7, col: 4 }], ["Kf1", { row: 7, col: 5 }],
                ["Kd2", { row: 6, col: 3 }], ["Kf2", { row: 6, col: 5 }],
                ["Kd3", { row: 5, col: 3 }], ["Ke3", { row: 5, col: 4 }], ["Kf3", { row: 5, col: 5 }],
            ];
            for (const [pgn, target] of cases) {
                assert.deepEqual(convert(pgn).target, target, pgn);
                assert.deepEqual(convert(pgn).source, { row: 6, col: 4 }, pgn);
            }
        });

        it("uses explicit from-square notation without searching the board", () => {
            game.loadGame(loadEmpty([
                { row: 7, col: 7, color: "white", pieceType: game.QUEEN },
                ...standardKings(),
            ]));
            assert.deepEqual(convert("Qh1e4").source, { row: 7, col: 7 });
            assert.deepEqual(convert("Qh1e4").target, { row: 4, col: 4 });
        });

        it("stops sliding scans when a blocking piece sits between target and source", () => {
            game.loadGame(loadEmpty([
                { row: 4, col: 0, color: "white", pieceType: game.ROOK },
                { row: 4, col: 4, color: "black", pieceType: game.PAWN },
                ...standardKings(),
            ]));
            assert.deepEqual(convert("Rd4").source, { row: 4, col: 0 });

            game.loadGame(loadEmpty([
                { row: 0, col: 0, color: "white", pieceType: game.BISHOP },
                { row: 5, col: 5, color: "black", pieceType: game.PAWN },
                ...standardKings(),
            ]));
            assert.deepEqual(convert("Be4").source, { row: 0, col: 0 });

            game.loadGame(loadEmpty([
                { row: 4, col: 0, color: "white", pieceType: game.QUEEN },
                { row: 4, col: 5, color: "black", pieceType: game.PAWN },
                ...standardKings(),
            ]));
            assert.deepEqual(convert("Qd4").source, { row: 4, col: 0 });
        });
    });
});
