    ...
    Joi.alternatives().try(
        Joi.object({
            ...
            data: Joi.object({
                ...
                selectedPiece: Joi.number().min(2).max(5),
                source: Joi.object({
        ...
        Joi.object({
            gameId: wsGameId,
            info: Joi.string().valid("offer rematch", "rematch", "resign", "offer draw", "move accepted", "draw accepted", "draw declined", "rematch declined", "rematch accepted", "outOfTime", "Opponent resigned", "chat", "clockSync").required(),
            isWhite: Joi.bool().optional(),
            moveTime: Joi.number().optional(),
            moveStr: Joi.string().optional().escapeHTML(),
